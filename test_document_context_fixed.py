#!/usr/bin/env python3
"""
Test AI Service with Document Context - Fixed
"""
...
# Quick status check - FIXED
st.sidebar.header("🔍 Status Check")

# Check AI Service - FIXED
ai_service = AIService()
# Check for 'client' instead of 'openai_client'
if hasattr(ai_service, 'client') and ai_service.client:
    st.sidebar.success("✅ OpenAI Connected")
elif hasattr(ai_service, 'openai_client') and ai_service.openai_client:
    st.sidebar.success("✅ OpenAI Connected")
else:
...
if os.getenv('GEMINI_API_KEY'):
    ...
    st.sidebar.warning("⚠️ Gemini Not Available")
