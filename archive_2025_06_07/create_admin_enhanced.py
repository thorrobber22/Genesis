#!/usr/bin/env python3
"""
Create enhanced admin with better error handling and logging
...
with open("admin_enhanced.py", 'w', encoding='utf-8') as f:
    f.write(admin_content)

print("✅ Created admin_enhanced.py with detailed logging and error handling")