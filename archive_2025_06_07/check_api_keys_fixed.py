#!/usr/bin/env python3
"""
Check API keys configuration (Fixed for GEMINI_API_KEY)
...
# Check Gemini key (REQUIRED for document validation)
gemini_key = os.getenv("GEMINI_API_KEY")
if gemini_key:
    print(f"\n✓ GEMINI_API_KEY: Set ({len(gemini_key)} chars)")
    print("  Used for: Document validation with Google Gemini")
else:
