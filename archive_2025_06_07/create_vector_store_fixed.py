#!/usr/bin/env python3
"""
Create a properly fixed vector_store.py
Date: 2025-06-05 14:25:13 UTC
Author: thorrobber22
"""
...
# Backup original
original_path = Path("core/vector_store.py")
if original_path.exists():
    backup_path = Path("core/vector_store_backup.py")
    with open(original_path, 'r', encoding='utf-8') as f:
        backup_content = f.read()
    with open(backup_path, 'w', encoding='utf-8') as f:
        f.write(backup_content)
    print("✓ Backed up original to core/vector_store_backup.py")

# Write new version
with open(original_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("✓ Created fixed core/vector_store.py")
print("\nNow run: python vector_store_test.py")