"""
components/companies_refined.py - Companies view with refined styling
"""
...
def render_company_view():
    ...
    if docs:
        # Table header
        col_type, col_date, col_size, col_action = st.columns([2, 2, 1, 1])
...
def render_company_context():
    ...
    # Context items with refined styling
    context_items = [
